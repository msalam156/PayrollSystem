...
public class Secretary extends SchoolEmployee {
	...
	Secretary(String name,int id, int years,String Department){
		super(name,id,years);
	...
	//getter method for salary that return the total salary of Secretary
	@Override
